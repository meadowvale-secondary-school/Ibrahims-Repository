 ...
 */
var Ibrahim = User(name: "Ibrahim", age: 16, height: 5, weight: 4, activityLevel: 13)
print(Ibrahim.name)
print(Ibrahim.age)
print(Ibrahim.height)
print(Ibrahim.weight)
print(Ibrahim.activityLevel)
 ...
 */
let anotherMile = Distance(feet: 1600)
print(anotherMile.meters)
